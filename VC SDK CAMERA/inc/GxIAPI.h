...
{
	GX_IP_CONFIGURE_DHCP       = 0x6,   ///< 
	GX_IP_CONFIGURE_LLA        = 0x4,   ///< 
	GX_IP_CONFIGURE_STATIC_IP  = 0x5,   ///< 
	GX_IP_CONFIGURE_DEFAULT    = 0x7,   ///< 
};
...
typedef enum GX_FEATURE_ID
{
	...
	GX_STRING_DEVICE_PHY_VERSION     		   = 18  | GX_FEATURE_STRING | GX_FEATURE_LEVEL_REMOTE_DEV,		///< 
	GX_ENUM_DEVICE_TEMPERATURE_SELECTOR		   = 19  | GX_FEATURE_ENUM   | GX_FEATURE_LEVEL_REMOTE_DEV,     ///< 
	GX_FLOAT_DEVICE_TEMPERATURE				   = 20  | GX_FEATURE_FLOAT  | GX_FEATURE_LEVEL_REMOTE_DEV, 	///< 
    ...
    GX_ENUM_REGION_SEND_MODE          = 1019 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< ROI output mode, see also GX_REGION_SEND_MODE
    GX_ENUM_REGION_MODE               = 1020 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< zone switch, see also GX_REGION_MODE
    GX_ENUM_RREGION_SELECTOR          = 1021 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Selects the Region of interest to control.Refer to GX_REGION_SELECTOR_ENTRY
	GX_INT_CENTER_WIDTH                = 1022 |GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,           ///< CENTER WIDTH 
	GX_INT_CENTER_HEIGHT               = 1023 |GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,           ///< CENTER HEIGHT
    GX_ENUM_BINNING_HORIZONTAL_MODE   = 1024 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_BINNING_HORIZONTAL_MODE_ENTRY
    GX_ENUM_BINNING_VERTICAL_MODE     = 1025 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_BINNING_VERTICAL_MODE_ENTRY
	GX_ENUM_SENSOR_SHUTTER_MODE		  = 1026 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Sensorshuttermode, Refer to GX_SENSOR_SHUTTER_MODE_ENTRY
    ...
    GX_ENUM_ACQUISITION_STATUS_SELECTOR     = 3031 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV, ///< Refer to GX_ACQUISITION_STATUS_SELECTOR_ENTRY
	...
	GX_FLOAT_EXPOSURE_OVERLAP_TIME_MAX      = 30301 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV,
	GX_ENUM_EXPOSURE_TIME_MODE              = 30302 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,  ///<Refer to GX_EXPOSURE_TIME_MODE_ENTRY
    ...
    GX_ENUM_GAMMA_MODE                = 5014 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< Refer to GX_GAMMA_MODE_ENTRY
	...
	GX_ENUM_LIGHT_SOURCE_PRESET       = 5017 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< Refer to GX_LIGHT_SOURCE_PRESET_ENTRY
	...
	GX_ENUM_SHARPNESS_MODE            = 6026 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< Refer to GX_SHARPNESS_MODE_ENTRY
	GX_FLOAT_SHARPNESS                = 6027 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV,  ///< 
	GX_ENUM_USER_DATA_FILED_SELECTOR  = 6028 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< Refer to GX_USER_DATA_FILED_SELECTOR_ENTRY
	GX_BUFFER_USER_DATA_FILED_VALUE   = 6029 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 
	GX_ENUM_FLAT_FIELD_CORRECTION     = 6030 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< Refer to GX_FLAT_FIELD_CORRECTION_ENTRY
	GX_ENUM_NOISE_REDUCTION_MODE      = 6031 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,   ///< 
	GX_FLOAT_NOISE_REDUCTION          = 6032 | GX_FEATURE_FLOAT | GX_FEATURE_LEVEL_REMOTE_DEV,  ///<
	GX_BUFFER_FFCLOAD				  = 6033 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 
	GX_BUFFER_FFCSAVE				  = 6034 | GX_FEATURE_BUFFER | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 
	...
	GX_INT_EVENT_INTERNAL_ERROR                   = 8013 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Internal Error Event ID
	GX_INT_EVENT_INTERNAL_ERROR_TIMESTAMP         = 8014 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Internal Error Event Time Stamp
	GX_INT_EVENT_FRAMEBURSTSTART_OVERTRIGGER      = 8015 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_INT_EVENT_FRAMEBURSTSTART_OVERTRIGGER_FRAMEID      = 8016 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_INT_EVENT_FRAMEBURSTSTART_OVERTRIGGER_TIMESTAMP    = 8017 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_INT_EVENT_FRAMESTART_WAIT                          = 8018 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_INT_EVENT_FRAMESTART_WAIT_TIMESTAMP                = 8019 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_INT_EVENT_FRAMEBURSTSTART_WAIT                     = 8020 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_INT_EVENT_FRAMEBURSTSTART_WAIT_TIMESTAMP           = 8021 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///<
	GX_INT_EVENT_BLOCK_DISCARD_FRAMEID                    = 8022 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///<
	GX_INT_EVENT_FRAMESTART_OVERTRIGGER_FRAMEID           = 8023 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_INT_EVENT_BLOCK_NOT_EMPTY_FRAMEID                  = 8024 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_INT_EVENT_FRAMESTART_WAIT_FRAMEID                  = 8025 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_INT_EVENT_FRAMEBURSTSTART_WAIT_FRAMEID             = 8026 | GX_FEATURE_INT | GX_FEATURE_LEVEL_REMOTE_DEV,    ///<
	...
	GX_ENUM_COLOR_TRANSFORMATION_MODE       = 11000 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_COLOR_TRANSFORMATION_MODE_ENTRY
    GX_BOOL_COLOR_TRANSFORMATION_ENABLE     = 11001 | GX_FEATURE_BOOL | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
    GX_ENUM_COLOR_TRANSFORMATION_VALUE_SELECTOR = 11002 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,///< Refer to GX_COLOR_TRANSFORMATION_VALUE_SELECTOR_ENTRY
    GX_FLOAT_COLOR_TRANSFORMATION_VALUE     = 11003 | GX_FEATURE_FLOAT| GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	
	//---------------CounterAndTimerControl Section-------------------------
	GX_ENUM_TIMER_SELECTOR                  = 12000 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_TIMER_SELECTOR_ENTRY
	GX_FLOAT_TIMER_DURATION                 = 12001 | GX_FEATURE_FLOAT| GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_FLOAT_TIMER_DELAY                    = 12002 | GX_FEATURE_FLOAT| GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	GX_ENUM_TIMER_TRIGGER_SOURCE            = 12003 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_TIMER_TRIGGER_SOURCE_ENTRY
	GX_ENUM_COUNTER_SELECTOR                = 12004 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_COUNTER_SELECTOR_ENTRY
	GX_ENUM_COUNTER_EVENT_SOURCE            = 12005 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_COUNTER_EVENT_SOURCE_ENTRY
	GX_ENUM_COUNTER_RESET_SOURCE            = 12006 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_COUNTER_RESET_SOURCE_ENTRY
	GX_ENUM_COUNTER_RESET_ACTIVATION        = 12007 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_COUNTER_RESET_ACTIVATION_ENTRY
	GX_COMMAND_COUNTER_RESET                = 12008 | GX_FEATURE_COMMAND | GX_FEATURE_LEVEL_REMOTE_DEV, ///< 
	GX_ENUM_COUNTER_TRIGGER_SOURCE          = 12009 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_COUNTER_TRIGGER_SOURCE_ENTRY
	GX_INT_COUNTER_DURATION					= 12010 | GX_FEATURE_INT  | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< 
	//---------------RemoveParameterLimitControl Section-------------------------
	GX_ENUM_REMOVE_PARAMETER_LIMIT          = 13000 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_REMOTE_DEV,    ///< Refer to GX_REMOVE_PARAMETER_LIMIT_ENTRY
	...
	GX_DS_INT_PACKET_TIMEOUT                  = 19 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS,  ///< Packet time out
	GX_DS_INT_SOCKET_BUFFER_SIZE			  = 20 | GX_FEATURE_INT | GX_FEATURE_LEVEL_DS,  ///< Socket buffer size in kilobytes
    GX_DS_ENUM_STOP_ACQUISITION_MODE		  = 21 | GX_FEATURE_ENUM | GX_FEATURE_LEVEL_DS,  ///< stop acquisition mode. Refer to GX_STOP_ACQUISITION_MODE_ENTRY
	GX_DS_ENUM_STREAM_BUFFER_HANDLING_MODE    = 22 | GX_FEATURE_ENUM| GX_FEATURE_LEVEL_DS,  ///< StreamBufferHandlingMode. Refer to GX_DS_STREAM_BUFFER_HANDLING_MODE_ENTRY
...
typedef enum GX_TRIGGER_SOURCE_ENTRY
{
	...
	GX_TRIGGER_SOURCE_COUNTER2END   = 5,                 ///<
...
typedef enum GX_LINE_SOURCE_ENTRY
{
    ...
    GX_ENUM_LINE_SOURCE_TIMER1_ACTIVE               = 8         ///< 
...
typedef enum GX_EVENT_SELECTOR_ENTRY
{
	...
	GX_ENUM_EVENT_SELECTOR_FRAMEBURSTSTART_OVERTRIGGER = 0x9005,       ///<
	GX_ENUM_EVENT_SELECTOR_FRAMESTART_WAIT             = 0x9006,       ///<
	GX_ENUM_EVENT_SELECTOR_FRAMEBURSTSTART_WAIT        = 0x9007,       ///<
...
{
	GX_DS_STREAM_BUFFER_HANDLING_MODE_OLDEST_FIRST              = 1,        ///< 
	GX_DS_STREAM_BUFFER_HANDLING_MODE_OLDEST_FIRST_OVERWRITE    = 2,        ///< 
	GX_DS_STREAM_BUFFER_HANDLING_MODE_NEWEST_ONLY               = 3,        ///< 
...
typedef enum GX_CHUNK_SELECTOR_ENTRY
{
	...
	GX_CHUNK_SELECTOR_CHUNK_COUNTER_VALUE= 3     ///< 
...
{
	GX_NOISE_REDUCTION_MODE_OFF   = 0,   ///< 
	GX_NOISE_REDUCTION_MODE_ON    = 1    ///<
...
{
	GX_SENSOR_SHUTTER_MODE_GLOBAL		= 0,    ///< All the pixels are exposed for the same length of time at the same time. 
	GX_SENSOR_SHUTTER_MODE_ROLLING		= 1,    ///< All the pixels are exposed for the same length of time but not at the same time.
	GX_SENSOR_SHUTTER_MODE_GLOBALRESET	= 2,	///< The pixels are exposed for different lengths of time.
...
typedef enum GX_LIGHT_SOURCE_PRESET_ENTRY
{
	...
	GX_LIGHT_SOURCE_PRESET_INCANDESCENT_A  			    = 5,
...
{
	GX_TIMER_SELECTOR_TIMER1   = 1,        ///<             
}GX_TIMER_SELECTOR_ENTRY;

typedef enum GX_TIMER_TRIGGER_SOURCE_ENTRY
{
	GX_TIMER_TRIGGER_SOURCE_EXPOSURE_START   = 1,        ///<        
}GX_TIMER_TRIGGER_SOURCE_ENTRY;

typedef enum GX_COUNTER_SELECTOR_ENTRY
{
	GX_COUNTER_SELECTOR_COUNTER1   = 1,        ///<       
	GX_COUNTER_SELECTOR_COUNTER2   = 2,        ///< Counter2
}GX_COUNTER_SELECTOR_ENTRY;

typedef enum GX_COUNTER_EVENT_SOURCE_ENTRY
{
	GX_COUNTER_EVENT_SOURCE_FRAME_START         = 1,        ///<     
	GX_COUNTER_EVENT_SOURCE_FRAME_TRIGGER       = 2,        ///< 
	GX_COUNTER_EVENT_SOURCE_ACQUISITION_TRIGGER = 3,        ///<  
	GX_COUNTER_EVENT_SOURCE_OFF					= 4, 	    ///<
	GX_COUNTER_EVENT_SOURCE_SOFTWARE			= 5,	    ///<
	GX_COUNTER_EVENT_SOURCE_LINE0				= 6,	    ///<
	GX_COUNTER_EVENT_SOURCE_LINE1				= 7,	    ///<
	GX_COUNTER_EVENT_SOURCE_LINE2				= 8,	    ///<
	GX_COUNTER_EVENT_SOURCE_LINE3				= 9,	    ///<

}GX_COUNTER_EVENT_SOURCE_ENTRY;

typedef enum GX_COUNTER_RESET_SOURCE_ENTRY
{
	GX_COUNTER_RESET_SOURCE_OFF      = 0,        ///<       
	GX_COUNTER_RESET_SOURCE_SOFTWARE = 1,        ///<       
	GX_COUNTER_RESET_SOURCE_LINE0    = 2,        ///<       
	GX_COUNTER_RESET_SOURCE_LINE1    = 3,        ///<       
	GX_COUNTER_RESET_SOURCE_LINE2    = 4,        ///<       
	GX_COUNTER_RESET_SOURCE_LINE3    = 5,        ///<       
	GX_COUNTER_RESET_SOURCE_COUNTER2END	= 6,	 ///<
}GX_COUNTER_RESET_SOURCE_ENTRY;

typedef enum GX_COUNTER_TRIGGER_SOURCE_ENTRY
{
	GX_COUNTER_TRIGGER_SOURCE_OFF      = 0,		///<
	GX_COUNTER_TRIGGER_SOURCE_SOFTWARE = 1,		///<
	GX_COUNTER_TRIGGER_SOURCE_LINE0    = 2,		///<
	GX_COUNTER_TRIGGER_SOURCE_LINE1    = 3,		///<
	GX_COUNTER_TRIGGER_SOURCE_LINE2    = 4,		///<
	GX_COUNTER_TRIGGER_SOURCE_LINE3    = 5,		///<
}GX_COUNTER_TRIGGER_SOURCE_ENTRY;

typedef enum GX_COUNTER_RESET_ACTIVATION_ENTRY
{
	GX_COUNTER_RESET_ACTIVATION_RISING_EDGE = 1,        ///<  
}GX_COUNTER_RESET_ACTIVATION_ENTRY;

typedef enum GX_USER_DATA_FILED_SELECTOR_ENTRY
{
	GX_USER_DATA_FILED_0    = 0,   ///<
	GX_USER_DATA_FILED_1    = 1,   ///<
	GX_USER_DATA_FILED_2    = 2,   ///<
	GX_USER_DATA_FILED_3    = 3,   ///<
}GX_USER_DATA_FILED_SELECTOR_ENTRY;

typedef enum GX_REMOVE_PARAMETER_LIMIT_ENTRY
{
	GX_ENUM_REMOVE_PARAMETER_LIMIT_OFF = 0,    ///< 
	GX_ENUM_REMOVE_PARAMETER_LIMIT_ON  = 1,    ///<
}GX_REMOVE_PARAMETER_LIMIT_ENTRY;

typedef enum GX_FLAT_FIELD_CORRECTION_ENTRY
{
	GX_ENUM_FLAT_FIELD_CORRECTION_OFF = 0,    ///<
...
{
	GX_EXPOSURE_TIME_MODE_ULTRASHORT  = 0,     ///< UltraShort
	GX_EXPOSURE_TIME_MODE_STANDARD    = 1,     ///< Standard
...
GX_API GXIsImplemented		      (GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, int* pbIsImplemented);
...
GX_API GXIsReadable               (GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, int* pbIsReadable);
...
GX_API GXIsWritable               (GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, int* pbIsWritable);
...
GX_API GXGetBool			      (GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, int* pbValue);
...
GX_API GXSetBool			      (GX_DEV_HANDLE hDevice, GX_FEATURE_ID_CMD featureID, int bValue);
...
GX_API GXImportConfigFile(GX_DEV_HANDLE hDevice, const char * pszFilePath, int bVerify);
...
GX_API GXImportConfigFileW(GX_DEV_HANDLE hDevice, const wchar_t * pszFilePath, int bVerify);

//----------------------------------------------------------------------------------
/**
\brief      
\param [in]hDevice         
\param [in]ui64Address     
\param [out]pBuffer        
\param [in, out]piSize     
...
// ---------------------------------------------------------------------------
		/**
		\brief       
		\param[in]   pszDevcieMacAddress 
		\param[in]   ui32IpConfigFlag     
...
//----------------------------------------------------------------------------------
/**
\brief      Users Set Auqusition buffer Number
\param [in]hDevice         Device Handle
\param [in]nBufferNum      Auqusition buffer Number
\return     GX_STATUS_SUCCESS             
			GX_STATUS_NOT_INIT_API       
			GX_STATUS_INVALID_HANDLE      
			GX_STATUS_INVALID_PARAMETER    
